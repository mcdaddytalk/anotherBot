...
module.exports = class ButtonCommand extends BaseCommand {
    ...
    async run(client, message, args) {
        ...
        const getSaveEmbed = (charGender, charClass) => {
            ...
            .setDescription(`Here are your selected choices:\nGender:  ${charGender}\nClass:  ${charClass}\nPress \`Save\` to finalize selections\nOr Press \`Cancel\` to exit`);
        }
        ...
        const genderRow = new MessageActionRow()        
            .addComponents(
                new MessageButton()
                .setCustomId('maleButton')
                .setLabel('Male')
                .setStyle('PRIMARY'),
                new MessageButton()
                .setCustomId('femaleButton')
                .setLabel('Female')
                .setStyle('SECONDARY'),
                new MessageButton()
                .setCustomId('cancel')
        ...
        const classRow = new MessageActionRow()        
            .addComponents(
                new MessageButton()
                .setCustomId('fighterButton')
                .setLabel('Fighter')
                .setStyle('SECONDARY'),
                new MessageButton()
                .setCustomId('rogueButton')
                .setLabel('Rogue')
                .setStyle('SECONDARY'),
                new MessageButton()
                .setCustomId('mageButton')
                .setLabel('Mage')
                .setStyle('SECONDARY'),
                new MessageButton()
                .setCustomId('priestButton')
                .setLabel('Priest')
                .setStyle('SECONDARY'),
                new MessageButton()
                .setCustomId('cancel')
        ...
        const saveRow = new MessageActionRow()
            .addComponents(
                    new MessageButton()
                    .setCustomId('save')
                    .setLabel('Save')
        ...
        message.channel.send({
                embeds: [startEmbed], components: [start]
            });
        ...
        collector.on('collect', async (interaction) => {
            ...
            switch (interaction.customId) {
                case 'start':
                    ...
                    break;
                case 'cancel':
                    await interaction.update({ content: 'Character generation canceled by user', embeds: [], components: [] });
                    break;
                case 'save':
